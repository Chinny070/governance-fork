...
describe("toneFor", () => {
  it.each([
    ["ENVELOPE_FAITHFUL", "ok"],
    ["FINALIZED_FAITHFUL", "ok"],
    ["SUCCESS", "ok"],
    ["FETCHED", "ok"],
    ["SETTLED_FULL_REFUND", "ok"],
    ["SETTLED_CHALLENGER_REWARD", "ok"],
    ["RESOLVED_FLIPPED", "ok"],
    ["ENVELOPE_REJECTED", "bad"],
    ["NOT_FAITHFUL", "bad"],
    ["FINALIZED_NOT_FAITHFUL", "bad"],
    ["INVALID", "bad"],
    ["FINALIZED_INVALID", "bad"],
    ["ABORTED", "bad"],
    ["ENVELOPE_ADJUDICATING", "warn"],
    ["ADJUDICATING", "warn"],
    ["FORK_CHALLENGE_OPEN", "warn"],
    ["OPEN", "warn"],
    ["UNUSABLE_SHORT", "warn"],
    ["SETTLED_PARTIAL_SLASH", "warn"],
    ["ENVELOPE_EVIDENCE_OPEN", "info"],
    ["CASE_FROZEN", "info"],
    ["UNSETTLED", "info"],
